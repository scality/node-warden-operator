...
type NodeRemediationPolicySpec struct {
	...
	// foo is an example field of NodeRemediationPolicy. Edit noderemediationpolicy_types.go to remove/update
	// +optional
...
type NodeRemediationPolicyStatus struct {
	...
	// conditions represent the current state of the NodeRemediationPolicy resource.
